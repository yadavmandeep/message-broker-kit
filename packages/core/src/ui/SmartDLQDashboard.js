...
class SmartDLQDashboard {
    ...
    setupRoutes(apiPath) {
        ...
        this.app.get(`${apiPath}/failed`, async (req, res) => {
            try {
        ...
        this.app.post(`${apiPath}/retry`, async (req, res) => {
        ...
        this.app.get('/broker-ui', (req, res) => {
            const html = `
                <!DOCTYPE html>
                <html lang="en">
                <head>
...
exports.SmartDLQDashboard = SmartDLQDashboard;
